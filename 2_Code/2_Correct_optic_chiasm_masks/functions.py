...
def create_groundtruth(group, subj, box_margin=(5,5,0)):
    ...
    os.makedirs('../../1_Data/4_X-mask_atlas-corrected/'+group+'/'+str(subj))
    nib.save(groundtruth_image,'../../1_Data/4_X-mask_atlas-corrected/'+group+'/'+str(subj)+'/X-mask_atlas-corrected_complete.nii.gz')
